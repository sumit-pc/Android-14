package me.globant.android14.screens.home
...
import me.globant.android14.ui.composables.ButtonForDemoOf
...
fun HomeScreen(
    ...
    LazyColumn(
        ...
        item {
            ...
            ButtonForDemoOf(Destination.LocationPermission, onClick)
            ...
            ButtonForDemoOf(Destination.BroadcastReceiver, onClick)
            ...
            ButtonForDemoOf(Destination.ShowNotification, onClick)
        }
    }
}
