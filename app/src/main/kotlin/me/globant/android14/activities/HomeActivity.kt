...
import me.globant.android14.nav.NavigationHost
...
import me.globant.android14.viewmodels.HomeViewModel
                ...
                SetupM3Scaffold(viewModel.currentScreen) { paddingValues ->
                    ...
                    NavigationHost(
                        ...
                        when (destination) {
                            ...
                            Destination.LocationPermission -> LocationPermissionActivity.start(this)
                            Destination.BroadcastReceiver -> BroadcastReceiverActivity.start(this)
                            Destination.ShowNotification -> NotificationActivity.start(this)
                            else -> {/* no-op */
                            }
                        }
                    }
